[![Travis build status shield](https://img.shields.io/travis/kosssi/cozy-quantified-self/master.svg)](https://travis-ci.org/kosssi/cozy-quantified-self)
[![NPM release version shield](https://img.shields.io/npm/v/cozy-quantified-self.svg)](https://www.npmjs.com/package/cozy-quantified-self)
[![Github Release version shield](https://img.shields.io/github/tag/kosssi/cozy-quantified-self.svg)](https://github.com/kosssi/cozy-quantified-self/releases)
[![NPM Licence shield](https://img.shields.io/npm/l/cozy-quantified-self.svg)](https://github.com/kosssi/cozy-quantified-self/blob/master/LICENSE)


[Cozy] Quantified Self
=======================
...
What's Cozy Quantified Self?
-----------------------

This application tracking anything of your life, to optimise task or just for fun.
...
Hacking the Cozy Quantified Self app requires you to [setup a dev environment][setup].

You can then clone the app repository and install dependencies:

```sh
$ git clone https://github.com/cozy/cozy-quantified-self.git
$ cd cozy-quantified-self
$ yarn install
```
...
$ docker run --rm -it -p 8080:8080 -v "$(pwd)/build":/data/cozy-app/cozy-quantified-self cozy/cozy-app-dev
or
$ yarn stack:docker
```

your app is available at http://cozy-quantified-self.cozy.tools:8080.
...
If you want to work on Cozy Quantified Self and submit code modifications, feel free to open pull-requests! See the [contributing guide][contribute] for more information about how to properly open pull-requests.
...
The lead maintainer for Cozy Quantified Self is [kosssi](https://github.com/kosssi), send him/her a :beers: to say hello!
...
Cozy Quantified Self is developed by Cozy Cloud and distributed under the [AGPL v3 license][agpl-3.0].
...
[tx-app]: https://www.transifex.com/cozy/cozy-quantified-self/dashboard/
